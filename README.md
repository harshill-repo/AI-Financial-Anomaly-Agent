# AI-Powered Financial Anomaly Detection Agent

### Executive Summary
An end-to-end anomaly detection system for financial data using Python and machine learning. The automated pipeline ingests raw Excel data, performs feature engineering, and applies multiple statistical and ML models to flag financial irregularities.
